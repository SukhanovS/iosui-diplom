...
class HabitsViewController: UIViewController {
    ...
    func navBarCustomization () {
        ...
        // создание кнопки "+"
        navigationItem.rightBarButtonItem = UIBarButtonItem(barButtonSystemItem:UIBarButtonItem.SystemItem.add, target: self, action: #selector(self.showModal))
        
    }
    
    //    функция перехода на создание привчки по кнопке "+"
    @objc func showModal() {
